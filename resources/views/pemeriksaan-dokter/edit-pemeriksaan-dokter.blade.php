                ...
                <div class="row">
                    <form action="{{ route('pemeriksaan-dokter.update', $pemeriksaan_dokter->ID_PEMERIKSAAN) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="tanggal" value="{{ $pemeriksaan_dokter->TGL_PEMERIKSAAN }}"class="form-control" id="exampleInputPassword1">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="biaya" value="{{ $pemeriksaan_dokter->BIAYA }}"class="form-control" id="exampleInputPassword1">
                        </div>
