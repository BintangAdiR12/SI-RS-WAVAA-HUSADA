                ...
                <div class="row">
                    <form action="{{ route('kamar.update', $kamar->ID_KAMAR) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="id_kamar" value="{{ $kamar->ID_KAMAR }}"class="form-control" id="exampleInputEmail1"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="no_kamar" value="{{ $kamar->NO_KAMAR }}"class="form-control" id="exampleInputPassword1"
                                placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Tipe Kamar</label>
                            <input type="text" name="tipe_kamar" value="{{ $kamar->TIPE_KAMAR }}"class="form-control" id="exampleInputPassword1"
                                placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Kapasitas</label>
                            <input type="number" name="kapasitas" value="{{ $kamar->KAPASITAS }}"class="form-control" id="exampleInputPassword1"
                                placeholder="">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kondisi" value="{{ $kamar->KONDISI }}"class="form-control" id="exampleInputPassword1"
                                placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Tarif Kamar</label>
                            <input type="number" name="tarif" value="{{ $kamar->TARIF }}"class="form-control" id="exampleInputPassword1"
                                placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Keterangan</label>
                            <textarea name="keterangan" id="keterangan" value="{{ $kamar->KETERANGAN }}"class="form-control"></textarea>
                        </div>
