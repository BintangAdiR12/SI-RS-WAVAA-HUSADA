                ...
                <div class="row">
                    <form action="{{ route('dokter.store') }}" method="post">
                        ...
                        {{-- <div class="form-group">
                            ...
                            <input type="text" name="id_dokter" class="form-control" id="exampleInputEmail1"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_dokter" class="form-control" id="exampleInputEmail1"
                                placeholder="Enter nama">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Spesialis</label>
                            <input type="text" name="spesialis" class="form-control" id="exampleInputPassword1"
                                placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">No Registrasi</label>
                            <input type="text" name="no_registrasi" class="form-control" id="exampleInputPassword1"
                                placeholder="">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="jadwal_kerja" class="form-control" id="exampleInputEmail1"
                                placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Tarif Konsultasi</label>
                            <input type="number" name="tarif" class="form-control" id="exampleInputEmail1"
                                placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Riwayat Pendidikan</label>
                            <input type="text" name="riwayat" class="form-control" id="exampleInputEmail1"
                                placeholder="">
                        </div>
