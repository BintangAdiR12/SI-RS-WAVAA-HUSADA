                ...
                <div class="row">
                    <form action="{{ route('pegawai.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_pegawai" class="form-control" id="exampleInputPassword1"
                                placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">No Registrasi</label>
                            <input type="text" name="no_registrasi" class="form-control" id="exampleInputEmail1"
                                placeholder="">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="jadwal_kerja" id="jadwal_kerja" class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Unit Kerja</label>
                            <textarea name="unit_kerja" id="unit_kerja" class="form-control"></textarea>
                        </div>
